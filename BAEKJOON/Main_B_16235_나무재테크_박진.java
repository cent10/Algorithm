...
public class Main_B_16235_나무재테크_박진 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int k = 0; k < K; k++) {
			spring();
//			System.out.println("spring:" +getNumOfTree());
			summer();
//			System.out.println("summer:" +getNumOfTree());
			fall();
//			System.out.println("fall:" +getNumOfTree());
			winter();
//			System.out.println("winter:" +getNumOfTree());
//			System.out.println("=====");
		}
