...
- Main_B_14890_경사로_박진 (Gold III - 14890 : 경사로)
  - 시뮬레이션 (14,284 kb, 100 ms)
    - 가로, 세로를 통째로 두번 체크하기 위해서 비슷한 코드를 두번 쓰다보니 너무 코드가 더럽게 됐음 --> 한 줄만 체크하는 메소드를 만들어줘서 가로 한 줄을 메소드로 확인하고, 세로는 1차원 temp배열에 옮겨줘서 메소드에 적용시키는 방식으로 하면, 메소드를 재활용해서 코드를 줄일 수 있음.
---
(2020-05-15)
